...
<div>
  <select name='category' onChange={set} className='border w-[10vw] min-w-[10rem] h-[2.5rem] flex'>
...
<div>
  <input type="checkbox" name="main" id="" value={addData.main}  onChange={set}  />
...
return <div className='flex gap-1' key={index}>
  ...
  <input type="text" name="input" id="" className=" w-full h-9  rounded-md border
lg:h-12 px-3 py-2
